...
export function Hero() {
    return (
        ...
        >
            ...
            <div className="site-container relative z-10 grid flex-1 items-center gap-12 px-3 py-16 sm:px-5 sm:py-20 lg:grid-cols-2 lg:gap-8 lg:px-8 lg:py-24 xl:gap-12 xl:px-10 2xl:px-12 2xl:py-32">
