            ...
            <article>
                <div className="relative aspect-video overflow-hidden bg-background">
                    ...
                    <span className="absolute inset-0 flex items-center justify-center">
                        <span className="flex size-14 items-center rounded-sm justify-center border border-white/25 bg-background/80 text-foreground transition-colors duration-300 group-hover:border-crimson group-hover:bg-crimson-hover">
                ...
                <div className="p-6 sm:p-7">
                    ...
                    {video.description && (
                        <p className="mt-4 max-w-xl line-clamp-3 break-all font-sans text-sm leading-6 text-foreground-muted">
                            {video.description}
                        </p>
                    )}
                </div>
