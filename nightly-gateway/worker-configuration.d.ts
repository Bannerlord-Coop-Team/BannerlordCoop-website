/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=nightly-gateway/wrangler.jsonc nightly-gateway/worker-configuration.d.ts` (hash: 07c0cd936443776457658f4c8a303e57)
// Runtime types generated with workerd@1.20260811.1 2026-08-13 nodejs_compat
interface __BaseEnv_Env {
	RELEASES: R2Bucket;
	DB: D1Database;
	PUBLIC_ORIGIN: "https://bannerlordcoop-nightly-gateway.garrett-luskey.workers.dev";
	LEGACY_R2_ORIGIN: "https://pub-bf6bfe4b880e4d1b83f4b09b10419f78.r2.dev";
	DISCORD_CLIENT_ID: "REPLACE_WITH_DISCORD_APPLICATION_ID";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "LEGACY_R2_ORIGIN" | "DISCORD_CLIENT_ID">> {}
}
