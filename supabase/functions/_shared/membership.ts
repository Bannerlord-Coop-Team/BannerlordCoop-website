...
export function parseSnapshot(value: unknown): Snapshot {
    ...
    for (const field of ["patreonUserId", "campaignId", "memberId"]) if (value[field] !== null && (typeof value[field] !== "string" || !IDENTIFIER.test(value[field] as string))) throw new Error("Invalid identifier");
